...
const Home = () => {
  ...
  const cardsData = [
    { title: "Building 0-1 design, in every click", type: "Customfurnish", year: "Professional 2024-2025", image: "img/projects/cf.webp", link: "#/customfurnish", openInNewTab: true, locked: false },
